...
- [ ] **初回審査リジェクト(2.1(a))への返信** — 1.0(3)が「デモQRコード画像が必要」でリジェクト(2026-07-24)。**ビルド作り直し不要**。対応は `notes/review-response-2.1a.md`(課題#22)。あなたの作業=生成済みQR画像 `photouploader-review-demo-qr.png` を Resolution Center に添付+英文返信を貼る、の2点のみ
