...
- [ ] **Cognito確認メールの到達性** — デフォルト送信は1日50通制限+差出人が `no-reply@verificationemail.com` で迷惑メールに入りやすい。まずガイドに「迷惑メールフォルダ確認」を明記、根本対応はテンプレートへのSES設定追加
- [ ] **AWS利用料の説明** — 従量課金であること・無料枠・超過時の目安(例: 1万枚≒50GBで月いくら)をアプリ内/LP/ストア説明文に明示(請求クレーム対策)
